$( document ).ready(function() {
      ...
      $('.adTemplate').append('<div class="logo"></div>');
      /*$('.adTemplate').append('<div class="carusel step_1" id="carousel">');
      ...
      $('.adTemplate').append('</div>');*/

      $('.adTemplate').append('<div class="circle_on_first_page step_1">');
          $('.circle_on_first_page').append('<div class="circle_on_first_page_1">');
              $('.circle_on_first_page_1').append('<img alt="q" src="img/foto_in_circle.jpg">');
          $('.circle_on_first_page').append('</div>');
      $('.adTemplate').append('</div>');


      $('.adTemplate').append('<div class="slgs step_1">');
         $('.slgs').append('<p>Laudya Cynthia Bella,<br>Aktris</p>');
      $('.adTemplate').append('</div>');
      $('.adTemplate').append('<div class="text_first_page step_1">');
      ...
      $('.adTemplate').append('</div>');
      $('.adTemplate').append('<form action="" method="post" id="form_sel" enctype="multipart/form-data">');
      ...
      $('.adTemplate').append('</form>');
      $('.adTemplate').append('<div class="text_second_page  sssqq step_2">');
         $('.sssqq').append('<h2>SHARE</h2>');
         $('.sssqq').append('<h1>GAYA HIJABMU</h1>');
         $('.sssqq').append('<p>Pilih gaya hijab yang paling kamu suka.</p>');
      $('.adTemplate').append('</div>');
      $('.adTemplate').append('<div class="work_place step_2">');
          ...
          $('.work_place').append('</div>');
      $('.adTemplate').append('</div>');
      $('.adTemplate').append('<div class="changhe_hijab step_2">');
                  ...
                  $('.carousel1').append('<div class="carousel-wrapper"> ');
                      $('.carousel-wrapper').append('<div class="carousel-items">');
                          $('.carousel-items').append('<div class="carousel-block">');
                              $('.carousel-block').append('<img id="hij_1" class="thumb border_grin"  src="'+path+'img/hijab.png" alt="hijab" />');
      ...
      $('.adTemplate').append('</div>');
      $('.adTemplate').append('<div class="btn_page2 step_2 affhet">');
          ...
          $('.btn_page2').append('</div>');
      $('.adTemplate').append('</div>');
      $('.adTemplate').append('<div class="text_second_page step_3 est beqqqq">');
          $('.est').append('<h2>SHARE</h2>');
          $('.est').append('<h1>GAYA HIJABMU</h1>');
          $('.est').append('<p>Wow! Kamu terlihat cantik. Share inspirasi gaya hijabmu ke teman.</p>');
      $('.adTemplate').append('</div>');
      $('.adTemplate').append('<div class="soc_sharing step_3">');
          $('.soc_sharing').append('<h5>Share</h5>');
          $('.soc_sharing').append('<div id="facebook_shar">');
            $('#facebook_shar').append('<img src="img/fb.png" alt="facebook">');
          $('.soc_sharing').append('</div>');
          $('.soc_sharing').append('<div id="twitter_shar">');
            $('#twitter_shar').append('<img src="img/tw.png" alt="twitter">');
          $('.soc_sharing').append('</div>');
      $('.adTemplate').append('</div>');
      $('.adTemplate').append('<div class="ad_banner step_3">');
          $('.ad_banner').append('<img src="img/product1.png" alt="product">');
      ...
      $('.adTemplate').append('<div class="coba step_3" style=" margin-left: 31px; ">');
          $('.coba').append('<p><span><</span> Coba Lagi</p>');
      $('.adTemplate').append('</div>');

      $('.adTemplate').append('<a href="http://www.hairfashion.me/hijab_fashion" class="step_3 inspirasi" target="_blank"><div style=" margin-left: 30px; ">');
          $('.inspirasi').append('<p>Inspirasi Hijab Lainnya</p>');
      $('.adTemplate').append('</div></a>');
    
    /* Loader Gif */
    $('.adTemplate').append('<div class="inst loader_gif" style="display:none;">');
                  ...
                  if (file.type.match(imageType)) {
                    ...
                    reader.onload = function(e) {
                      ...
                      fileDisplayArea.appendChild(img);
                        ...
                        $('.adTemplate').append('<div class="inst guide_gif">');
                        $('.guide_gif').append('<img src="img/gif.gif">');
                        ...
                        /* SelfFie Tracking */
                        if (typeof custTracker != 'undefined' && typeof custTracker[0] != 'undefined' && custTracker[0] != '' && photoTracker1 == 0) {
                            photoTracker1 = 1;
                            $('body').append('<img src="' + custTracker[0] + '&ii=sh_selfie&tt=E" style="display:none;"/>');
                        }
                        if (typeof custTracker != 'undefined' && typeof custTracker[1] != 'undefined' && custTracker[1] != '' && photoTracker2 == 0) {
                            photoTracker1 = 1;
...
/******/ ])
                ...
                $('#take-picture').change( function() {
                  $(function(){
                    ...
                    //$(".adTemplate").css("background","url(img/bg.png)");
                    $(".adTemplate").css("background-color","#fff");
          ...
          mergeImage : function (options) {
              ...
              imgObj[0].onload = function() {
                  ...
                  imgObj[1].onload = function() {
                      ...
                      ctx.drawImage(imgObj[1], 0, 0, 672, 505);
